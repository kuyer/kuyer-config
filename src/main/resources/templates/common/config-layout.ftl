...
<link rel="stylesheet" href="<@s.url '/css/config.css' />" />
<#if styles?exists>
...
<div class="page">
	<div class="view header">
		<div class="wrap cleax">
			<div class="item"><a href="<@s.url '/' />" class="title">枯叶配置中心</a></div>
			<div class="item"><a href="<@s.url '/' />" class="active"><span>首页</span></a></div>
			<div class="item"><a href="javascript:;"><span>主机配置</span></a></div>
			<div class="item"><a href="javascript:;"><span>服务配置</span></a></div>
		</div>
	</div>
	${body}
...
<script type="text/javascript" src="<@s.url '/js/config.js' />"></script>
<#if scripts?exists>
